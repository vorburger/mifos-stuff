...
/usr/local/mysql/bin/mysql -D mifos -u mifos -pmifos     < ../../vorburger-mifos-head/application/src/main/sql/custom_data.sql
/usr/local/mysql/bin/mysql -D mifostest -u mifos -pmifos < ../../vorburger-mifos-head/application/src/main/sql/custom_data.sql
...
/usr/local/mysql/bin/mysql -D mifostest -u mifos -pmifos < ../../vorburger-mifos-head/application/src/main/sql/testdbinsertionscript.sql
